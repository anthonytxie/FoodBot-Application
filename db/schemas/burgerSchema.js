...
const burgerSchema = new Schema(
  {
    ...
    premiumToppings: [{
      type: String,
      enum: ['glutenFreeBun', 'grilledCheeseBun', 'threePartBun', 'chickenPatty', 'soyPatty', 'stuffedPortobello', 'bacon', 'caramelizedOnions', 'americanCheese', 'blueCheese', 'cheeseSauce', 'gravySide', 'sauteedMushrooms', 'blueCheese', 'swissCheese']
    }],
    // ===== Standard Items ===============================================================
    standardToppings: [{
      type: String,
      enum: ['lettuceBun', 'pickles', 'lettuce', 'tomatoes', 'onions', 'friedEgg', 'ketchup', 'mustard', 'mayo', 'relish', 'fancySauce', 'hotSauce', 'tomato', 'pickle', 'onion', 'hotPepper']
    }]  
